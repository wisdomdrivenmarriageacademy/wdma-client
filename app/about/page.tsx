...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-card text-foreground">
      ...
      <section className="bg-card px-5 py-24 sm:px-8">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] bg-panel text-panel-foreground lg:grid-cols-2">
          <div className="p-8 sm:p-12">
            ...
            <p className="mt-5 leading-7 text-panel-muted">
          ...
          <div className="grid gap-px bg-card/10 sm:grid-cols-2">
            {[
              ...
              <div key={title} className="bg-panel-strong p-8">
