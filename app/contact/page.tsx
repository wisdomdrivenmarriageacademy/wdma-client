  ...
  return (
    <main className="min-h-screen bg-card text-foreground">
      ...
      <section className="bg-background px-5 py-20 sm:px-8">
        <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[2rem] border border-border bg-card lg:grid-cols-[.9fr_1.1fr]">
          <div className="bg-panel p-8 text-panel-foreground sm:p-12">
            <span className="grid size-12 place-items-center rounded-xl bg-card/10 text-brand-gold">
              <Mail className="size-5" />
            </span>
            <h2 className="mt-8 text-3xl font-semibold tracking-[-0.04em]">
              Send us an email
            </h2>
            <p className="mt-4 leading-7 text-panel-muted">
              For the best support, write from the email address connected to
              your WDMA account.
            </p>
          </div>
          <div className="flex flex-col justify-center p-8 sm:p-12">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-brand-gold-strong">
              Email address
            </p>
            <a
              href="mailto:thewisdomdrivenmarriageacademy@gmail.com"
              className="mt-3 break-words text-xl font-semibold text-primary hover:underline sm:text-2xl"
            >
            ...
            <Button
              asChild
              size="lg"
              className="mt-7 w-fit shadow-sm"
            >
